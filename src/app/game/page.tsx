        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-100 p-4 rounded-lg">
            ...
            <div className="mt-2 space-y-2">
              ...
              <div className="flex space-x-2">
                <Button onClick={() => changeBrushSize(2)} className="w-8 h-8">
                  S
                </Button>
                <Button onClick={() => changeBrushSize(5)} className="w-8 h-8">
                  M
                </Button>
                <Button onClick={() => changeBrushSize(10)} className="w-8 h-8">
                  L
                </Button>
              </div>
